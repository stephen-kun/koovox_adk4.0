...
uint16 epb_base_request_pack_size(BaseRequest *request)
{
	uint16 pack_size = 0;
...
uint16 epb_pack_base_request(BaseRequest *request, uint8 *buf, uint16 buf_len)
{
	Epb epb;
...
BaseResponse *epb_unpack_base_response(const uint8 *buf, uint16 buf_len)
{
	Epb epb;
...
BasePush *epb_unpack_base_push(const uint8 *buf, uint16 buf_len)
{
	Epb epb;
...
uint16 epb_auth_request_pack_size(AuthRequest *request)
{
	uint16 pack_size = 0;
	uint16 len = 0;
...
uint16 epb_pack_auth_request(AuthRequest *request, uint8 *buf, uint16 buf_len)
{
	Epb epb;
	uint16 ret;
	uint16 tmp_len;
...
AuthResponse *epb_unpack_auth_response(const uint8 *buf, uint16 buf_len)
{
	const uint8 *tmp;
	uint16 tmp_len;
...
uint16 epb_init_request_pack_size(InitRequest *request)
{
	uint16 pack_size = 0;
	uint16 len = 0;
...
uint16 epb_pack_init_request(InitRequest *request, uint8 *buf, uint16 buf_len)
{
	Epb epb;
	epb_pack_init(&epb, buf, buf_len);
...
InitResponse *epb_unpack_init_response(const uint8 *buf, uint16 buf_len)
{
	const uint8 *tmp;
	uint16 tmp_len;
...
uint16 epb_send_data_request_pack_size(SendDataRequest *request)
{
	uint16 pack_size = 0;
	uint16 len = 0;
...
uint16 epb_pack_send_data_request(SendDataRequest *request, uint8 *buf, uint16 buf_len)
{
	Epb epb;
	uint16 ret;
	uint16 tmp_len;
...
SendDataResponse *epb_unpack_send_data_response(const uint8 *buf, uint16 buf_len)
{
	Epb epb;
	const uint8 *tmp;
	uint16 tmp_len;
...
RecvDataPush *epb_unpack_recv_data_push(const uint8 *buf, uint16 buf_len)
{
	Epb epb;
	const uint8 *tmp;
	uint16 tmp_len;
...
SwitchViewPush *epb_unpack_switch_view_push(const uint8 *buf, uint16 buf_len)
{
	Epb epb;
	const uint8 *tmp;
	uint16 tmp_len;
...
SwitchBackgroudPush *epb_unpack_switch_backgroud_push(const uint8 *buf, uint16 buf_len)
{
	Epb epb;
	const uint8 *tmp;
	uint16 tmp_len;
