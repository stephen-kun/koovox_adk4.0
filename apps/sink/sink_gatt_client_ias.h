...
/*******************************************************************************
NAME
    sinkGattIasClientGetCachedLevel
    
DESCRIPTION
    Gets the cached alert level to be set for a remote device when in client role.
...
DESCRIPTION
    Switch mode to central or peripheral based on the device type and store alert level to be set for remote device
    
PARAMETERS
    alert_level     The Alert Level to be set on remote device
    dev_type       Device type used to distinguish if mode to be switched to central or peripheral
