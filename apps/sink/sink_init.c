...
{
    uint8 i;
    int16 defaultMainA2DPVolume = ((sinkVolumeGetGroupConfig(multi_channel_group_main).no_of_steps * theSink.features.DefaultA2dpVolLevel)/ VOLUME_NUM_VOICE_STEPS);
    int16 defaultAuxA2DPVolume = ((sinkVolumeGetGroupConfig(multi_channel_group_aux).no_of_steps * theSink.features.DefaultA2dpVolLevel)/ VOLUME_NUM_VOICE_STEPS);
