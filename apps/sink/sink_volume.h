...
*/
void VolumeModifyAndUpdateTWSDeviceTrim(const volume_direction dir, const tws_device_type tws_device, const volume_info * const currentVolumes);
...
void VolumeModifyAndUpdateRoutedAudioAuxVolume(const volume_direction direction);
