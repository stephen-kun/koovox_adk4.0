...
/*!
* Macro to for each Notification Category 
*/
#define ANCS_OTHER_CATEGORY                     0x0001
#define ANCS_INCOMING_CALL_CATEGORY             0x0002
#define ANCS_MISSED_CALL_CATEGORY               0x0004
#define ANCS_VOICE_MAIL_CATEGORY                0x0008
#define ANCS_SOCIAL_CATEGORY                    0x0010
#define ANCS_SCHEDULE_CATEGORY                  0x0020
#define ANCS_EMAIL_CATEGORY                     0x0040
#define ANCS_NEWS_CATEGORY                      0x0080
#define ANCS_HEALTH_N_FITNESS_CATEGORY          0x0100
#define ANCS_BUSSINESS_N_FINANCE_CATEGORY       0x0200
#define ANCS_LOCATION_CATEGORY                  0x0400
#define ANCS_ENTERTAINMENT_CATEGORY             0x0800
