 ...
 */
typedef struct PACK_STRUCT __GATT_BATTERY_CLIENT_READ_LEVEL_CFM
{
    const GBASC *battery_client;
    gatt_battery_client_status_t status;
    uint8 battery_level;
 ...
 */
typedef struct PACK_STRUCT __GATT_BATTERY_CLIENT_SET_NOTIFICATION_ENABLE_CFM
{
    const GBASC *battery_client;
    gatt_battery_client_status_t status;
 ...
 */ 
typedef struct PACK_STRUCT __GATT_BATTERY_CLIENT_READ_DESCRIPTOR_CFM
{
    const GBASC *battery_client;
    gatt_battery_client_status_t status;
