...
static void handle_hid_client_gatt_msg(Task task, MessageId id, Message msg);       
...
static void handle_hid_client_write_characteristic_value_cfm(GHIDC_T *const hid_client,
      GATT_MANAGER_WRITE_CHARACTERISTIC_VALUE_CFM_T* write_cfm)
{
...
static void handle_hid_client_gatt_manager_msg(Task task, MessageId id, Message msg)
{
    ...
    GATT_HID_CLIENT_DEBUG_INFO(("Func: handle_hid_client_gatt_manager_msg(): Message ID = %x \n",id));
    ...
    switch(id)
    {
        ...
        {
            handle_hid_client_notification_ind(hid_client,(GATT_MANAGER_REMOTE_SERVER_NOTIFICATION_IND_T*)msg);
        }
        break;
        ...
        {
            handle_hid_client_discover_all_char_cfm(hid_client,(GATT_MANAGER_DISCOVER_ALL_CHARACTERISTICS_CFM_T*)msg);
        }
        break;
        /* Characteristic Descriptor Confirme */
        case GATT_MANAGER_DISCOVER_ALL_CHARACTERISTIC_DESCRIPTORS_CFM:
        {
            handle_hid_client_discover_all_char_descriptors_cfm(hid_client,(GATT_MANAGER_DISCOVER_ALL_CHARACTERISTIC_DESCRIPTORS_CFM_T*)msg);
        }
        break;
        /* Handle Characteristic value read */
        case GATT_MANAGER_READ_CHARACTERISTIC_VALUE_CFM:
        {
            handle_hid_client_read_characteristic_value_cfm(hid_client,(GATT_MANAGER_READ_CHARACTERISTIC_VALUE_CFM_T*)msg);
        }
        break;
        /* Handle Read Long Characteristic Values */
        case GATT_MANAGER_READ_LONG_CHARACTERISTIC_VALUE_CFM:
        {
            handle_hid_client_read_long_char_value_cfm(hid_client,(GATT_MANAGER_READ_LONG_CHARACTERISTIC_VALUE_CFM_T*)msg);
        }
        break;
        /*  Handle read using UUID */
        case GATT_MANAGER_READ_USING_CHARACTERISTIC_UUID_CFM:
        {
           handle_hid_client_read_using_uuid_cfm(hid_client,(GATT_MANAGER_READ_USING_CHARACTERISTIC_UUID_CFM_T*)msg);
        }
        break;
        /* Handle write without response */
        case GATT_MANAGER_WRITE_WITHOUT_RESPONSE_CFM:
        {
            handle_hid_client_write_without_response_cfm(hid_client,(GATT_MANAGER_WRITE_WITHOUT_RESPONSE_CFM_T*)msg);
        }
        break;
        /* Handle write characteristic value reponse  */
        case GATT_MANAGER_WRITE_CHARACTERISTIC_VALUE_CFM:
        {
            handle_hid_client_write_characteristic_value_cfm(hid_client,(GATT_MANAGER_WRITE_CHARACTERISTIC_VALUE_CFM_T*)msg);
        }
        break;
...
{
    GHIDC_T *const hid_client = (GHIDC_T*)task;
    GATT_HID_CLIENT_DEBUG_INFO(("Func: handle_hid_client_internal_msg(): Message ID = %x \n",id));
    ...
    switch(id)
    {
        ...
        {
            hid_client_start_discovery(hid_client,(HID_CLIENT_INTERNAL_MSG_DISCOVER_T*)msg);
        }
        break;

        case HID_CLIENT_INTERNAL_MSG_DISCOVER_COMPLETE:
        {
            hid_client_complete_discovery(hid_client, ((HID_CLIENT_INTERNAL_MSG_DISCOVER_T*)msg)->cid);
        }
        break;
        ...
        {
            hid_client_read_get_report(hid_client,(HID_CLIENT_INTERNAL_MSG_GET_REPORT_T*)msg);
        }
        break;
        ...
        {
            hid_client_read_boot_report(hid_client,(HID_CLIENT_INTERNAL_MSG_READ_BOOT_REPORT_T*)msg);
        }
        break;
        /* Internal Write Requests */
        case HID_CLIENT_INTERNAL_SET_PROTOCOL_BOOT:
        {
            hid_client_write_set_boot_protocol(hid_client);
        }
        break;
        
        case HID_CLIENT_INTERNAL_SET_PROTOCOL_REPORT:
        {
            hid_client_write_set_report_protocol(hid_client);
        }
        break;

        case HID_CLIENT_INTERNAL_SET_CTRL_POINT:
        {
            hid_client_write_set_control_point(hid_client,(HID_CLIENT_INTERNAL_SET_CTRL_POINT_T*)msg);
        }
        break;

        case HID_CLIENT_INTERNAL_MSG_SET_REPORT:
        {
            hid_client_write_set_report_request(hid_client,(HID_CLIENT_INTERNAL_MSG_SET_REPORT_T*)msg);
        }
        break;

        case HID_CLIENT_INTERNAL_MSG_WRITE_BOOT_REPORT:
        {
            hid_client_write_boot_report_request(hid_client,(HID_CLIENT_INTERNAL_MSG_WRITE_BOOT_REPORT_T*)msg);
        }
        break;

        /* Internal Notification requests */
        case HID_CLIENT_INTERNAL_HANLDE_NOTIFICTION_REQ:
        {
            hid_client_notification_reg_request(hid_client,(HID_CLIENT_INTERNAL_HANLDE_NOTIFICTION_REQ_T*)msg);
        }
        break;

        case HID_CLIENT_INTERNAL_SET_NOTIFICATION_CCDHANDLE_REQ:
        {
            hid_client_notification_reg_request_ccdhandle(hid_client,(HID_CLIENT_INTERNAL_SET_NOTIFICATION_CCDHANDLE_REQ_T*)msg);
        }
        break;
...
void hid_client_msg_handler(Task task, MessageId id, Message msg)
{
    ...
    {
         handle_hid_client_gatt_msg(task,id,msg);       
    }
