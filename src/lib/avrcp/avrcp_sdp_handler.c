...
#define avrcp_controller_default(avrcp)     (avrcp_controller_cat_default(avrcp) && !avrcp_browsing_supported(avrcp))

#define avrcp_target_cat_default(avrcp)     (avrcp->local_target_features == AVRCP_TARGET_CAT_DEFAULT)
#define avrcp_target_default(avrcp)         (avrcp_target_cat_default(avrcp) && !avrcp_browsing_supported(avrcp))
