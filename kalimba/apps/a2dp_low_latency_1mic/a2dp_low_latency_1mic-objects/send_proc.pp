...
.MODULE $M.CVC_MODULES_STAMP;
   ...
   .BLOCK ModulesStamp;
      ...
      .VAR s2 = 0xfeeb;
      .VAR s3 = 0xfeeb;
      .VAR CompConfig = 0*0x200000 + 0*0x080000 + 1*0x040000 + 1*0x020000 + 1*0x010000 + 1*0x008000 + 1*0x004000 + 1*0x002000 + 1*0x001000 + 0*0x000800 + 1*0x000400 + 1*0x000200 + 1*0x000100 + 1*0x000080 + 1*0x000040 + 1*0x000020 + 1*0x000010 + 0*0x000008;
      .VAR s4 = 0xfeeb;
      .VAR s5 = 0xfeeb;
      .VAR s6 = 0xfeeb;
   .ENDBLOCK;
...
.CONST $CVC_ONEMIC_HEADSET_SECID 0x258C;
   ...
   .VAR CVC_config_struct[$M.CVC.CONFIG.STRUC_SIZE] =
      ...
      $CVC_VERSION,
      $M.A2DP_LOW_LATENCY_1MIC.SYSMODE.PASSTHRU,
...
.linefile 428 "send_proc.asm"
   r2 = $M.CVC.VMMSG.CODEC;
   call $message.send_short;
   jump $pop_rLink_and_rts;

.ENDMODULE;
.linefile 442 "send_proc.asm"
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/a2dp_low_latency_1mic_defaults_FA1M.dat" 1
...
0x420B, 0x8B03, 0x0F10,
0x420B, 0x8B00, 0xECE9,
0x6203, 0x2E00, 0x9E21,
0x7C99, 0x7B00, 0x76AB,
0x0800, 0x00F9, 0xB037,
0xFA05, 0x42FE, 0x56CC,
0xFF80, 0x7110, 0x0000,
0x0800, 0x0001, 0x5555,
0x00CC, 0xCC3E, 0x4859,
0x02D0, 0x253E, 0x4859,
0x00D9, 0xBA5E, 0x4272,
0x0091, 0x4F7B, 0x6F08,
0x006D, 0x0B08, 0x0000,
0x0000, 0x0000, 0x03E0,
0x0003, 0xE000, 0x03E0,
0x0003, 0xE000, 0x03E0,
0x0003, 0xE000, 0x03E0,
0x0003, 0xE000, 0x03E0,
0x0003, 0xE000, 0xE216,
0x7999, 0x9979, 0x9999,
0x0000, 0x017F, 0xFFFF,
0xFFFF, 0xD000, 0x0000,
...
0x0000, 0x0300, 0x0001,
0x4000, 0x0037, 0x3CC8,
