...
// refresh from persistence
   ...
   r1 = M[$M.hf.LoadPersistResp.persistent_current_alpha_index_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.CURRENT_ALPHA_INDEX_FIELD] = r1;
   
   r1 = M[$M.hf.LoadPersistResp.persistent_current_alpha_index_dac];
   ...
   r1 = M[$M.hf.LoadPersistResp.persistent_average_io_ratio_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD] = r1;
   
   r1 = M[$M.hf.LoadPersistResp.persistent_average_io_ratio_dac];
   ...
   r1 = M[$M.hf.LoadPersistResp.persistent_warp_value_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD] = r1;
   
   r1 = M[$M.hf.LoadPersistResp.persistent_warp_value_dac];
   ...
   r1 = M[$M.hf.LoadPersistResp.persistent_inverse_warp_value_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD] = r1;
   
   r1 = M[$M.hf.LoadPersistResp.persistent_inverse_warp_value_dac];
   ...
   r1 = M[$M.hf.LoadPersistResp.persistent_sra_current_rate_adc];
   M[$adc_in.sw_copy_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD] = r1;
   
   r1 = M[$M.hf.LoadPersistResp.persistent_sra_current_rate_dac];
...
.CONST $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_ADC              3;
.CONST $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_DAC              4;

.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB              5;
.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_ADC              6;
.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_DAC              7;

.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB              8;
.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_ADC              9;
.CONST $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_DAC              10;

.CONST $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET_USB                    11;
.CONST $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET_ADC                    12;
.CONST $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET_DAC                    13;

.CONST $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET_USB                    14;
.CONST $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET_ADC                    15;
.CONST $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET_DAC                    16;

.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB            17;
.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_ADC            18;
.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_DAC            19;

.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB            20;
.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_ADC            21;
.CONST $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_DAC            22;

.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB              23;
.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_ADC              24;
.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_DAC              25;

.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB              26;
.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_ADC              27;
.CONST $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_DAC              28;
  
.CONST $CVC_HF_PERSIST_NUM_ELEMENTS                                  29; // Number of persistance elements
...
func:
   ...
   r0 = M[r3 + $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_ADC];
   M[persistent_current_alpha_index_adc] = r0;
   
   r0 = M[r3 + $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_DAC];
   ...
   r0 = M[r3 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_average_io_ratio_adc] = r0;
   
   r0 = M[r3 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   r0 = M[r3 + $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_warp_value_adc] = r0;
   
   r0 = M[r3 + $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   r0 = M[r3 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_inverse_warp_value_adc] = r0;
   
   r0 = M[r3 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   ...
   r0 = M[r3 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_sra_current_rate_adc] = r0;
   
   r0 = M[r3 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
...
persist_store:
   ...
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_ADC] = r0;
   
   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.CURRENT_ALPHA_INDEX_FIELD];
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_DAC] = r0;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf  + 1 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_ADC] = r1;
   
   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf  + 1 + $CVC_HF_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_DAC] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET_ADC] = r1;
   
   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_WARP_VALUE_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_WARP_VALUE_LO_OFFSET_DAC] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_ADC] = r1;
   
   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_DAC] = r1;
   ...
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_ADC] = r1;
   
   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD];
   r1 = r0 LSHIFT -8;                                                   // Bits 23-8
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;                                                    // Bits 7-0
   M[&persist_data_hf + 1 + $CVC_HF_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_DAC] = r1;
