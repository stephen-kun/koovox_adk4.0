...
.ENDMODULE;
.linefile 62 "cvc_FrontEnd.asm"
.MODULE $adc_in;
   .DATASEGMENT DM;
.linefile 75 "cvc_FrontEnd.asm"
...
.ENDMODULE;
.linefile 308 "cvc_FrontEnd.asm"
.MODULE $dac_out;
   .DATASEGMENT DM;
.linefile 322 "cvc_FrontEnd.asm"
   ...
   .BLOCK audio_out_volume;
    ...
    .BLOCK hw_copy_op;
        ...
        .VAR hw_copy_op.main_next = &hw_rate_adjust_op;
    ...
    .BLOCK hw_rate_adjust_op;
        .VAR hw_rate_adjust_op.mtu_next = &hw_copy_op;
        .VAR hw_rate_adjust_op.main_next = &rate_match_demux;
        .VAR hw_rate_adjust_op.func = &$cbops.hw_warp_op;
        .VAR hw_rate_adjust_op.param[$cbops.hw_warp_op.STRUC_SIZE] =
            $DAC_PORT_L,
            6,
            0x30,
            0,
...
$ConfigureFrontEnd:
    ...
    r1 = M[frame_dac_sampling_rate];
    r3 = 10;
    r8 = &$dac_out.hw_rate_adjust_op.param;
    call $cbops.hw_warp_op.Initialize;
