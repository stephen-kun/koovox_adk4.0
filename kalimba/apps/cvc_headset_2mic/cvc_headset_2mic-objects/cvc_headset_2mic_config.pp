...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/frame_codec.h" 1
.linefile 11 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/frame_codec.h"
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/plc100_library.h" 1
.linefile 22 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/plc100_library.h"
   .CONST $PLC100_VERSION 0x010000;
.linefile 31 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/plc100_library.h"
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_headset_2mic_config.h" 1
.linefile 13 "cvc_headset_2mic.h" 2
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_headset_2mic_library_gen.h" 1
.linefile 12 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_headset_2mic_library_gen.h"
...
.linefile 110 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_headset_2mic_library_gen.h"
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_system_library.h" 1
.linefile 10 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_system_library.h"
...
.linefile 11 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_system_library.h" 2
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/fft_twiddle.h" 1
.linefile 11 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/fft_twiddle.h"
...
.linefile 3892 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/fft_twiddle.h"
         ...
         .VAR/DM_IMAG_TWIDDLE $fft.twiddle_imag[128] =
            ...
            -0.9996988187,
            -0.0245412285;
.linefile 4490 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/fft_twiddle.h"
.ENDMODULE;
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_headset_2mic_defaults_WB.dat" 1
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_headset_2mic_defaults_FE.dat" 1
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/cvc_headset_2mic_defaults_NB.dat" 1
...
.linefile 1446 "cvc_headset_2mic_config.asm"
...
.linefile 1607 "cvc_headset_2mic_config.asm"
 ...
 .VAR/DM hfk_proc_funcsSnd[] =
      ...
      0;
.linefile 1767 "cvc_headset_2mic_config.asm"
   ...
   .VAR stream_map_refin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      0 ...;
.linefile 1844 "cvc_headset_2mic_config.asm"
   .VAR stream_map_left_adc[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1861 "cvc_headset_2mic_config.asm"
   .VAR stream_map_right_adc[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1879 "cvc_headset_2mic_config.asm"
   .VAR stream_map_sndout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      0 ...;
.linefile 1901 "cvc_headset_2mic_config.asm"
   .VAR stream_map_rcvin[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_input_streams_ind,
      0 ...;
.linefile 1921 "cvc_headset_2mic_config.asm"
   .VAR stream_map_rcvout[$framesync_ind.ENTRY_SIZE_FIELD] =
      ...
      $frame_sync.update_output_streams_ind,
      0 ...;
.linefile 1944 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2022 "cvc_headset_2mic_config.asm"
...
lp_param_copy:
   ...
   r1 = M[$M.2mic.LoadPersistResp.persistent_current_alpha_index_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.CURRENT_ALPHA_INDEX_FIELD] = r1;

   r1 = M[$M.2mic.LoadPersistResp.persistent_current_alpha_index_dac];
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.CURRENT_ALPHA_INDEX_FIELD] = r1;
   ...
   r1 = M[$M.2mic.LoadPersistResp.persistent_average_io_ratio_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD] = r1;

   r1 = M[$M.2mic.LoadPersistResp.persistent_average_io_ratio_dac];
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD] = r1;
   ...
   r1 = M[$M.2mic.LoadPersistResp.persistent_warp_value_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD] = r1;

   r1 = M[$M.2mic.LoadPersistResp.persistent_warp_value_dac];
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD] = r1;
   ...
   r1 = M[$M.2mic.LoadPersistResp.persistent_inverse_warp_value_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD] = r1;

   r1 = M[$M.2mic.LoadPersistResp.persistent_inverse_warp_value_dac];
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD] = r1;
   ...
   r1 = M[$M.2mic.LoadPersistResp.persistent_sra_current_rate_adc];
   M[$adc_in.sw_copy_left_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD] = r1;

   r1 = M[$M.2mic.LoadPersistResp.persistent_sra_current_rate_dac];
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD] = r1;




   M[$far_end.in.sw_rate_op.param + $cbops.rate_monitor_op.ACCUMULATOR_FIELD] = 0;
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.ACCUMULATOR_FIELD] = 0;
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.ACCUMULATOR_FIELD] = 0;
   ...
   r1 = M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.IDLE_PERIODS_AFTER_STALL_FIELD];
   r1 = 0 - r1;
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.COUNTER_FIELD] = r1;

   r1 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.IDLE_PERIODS_AFTER_STALL_FIELD];
   r1 = 0 - r1;
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.COUNTER_FIELD] = r1;



   r1 = $cbops.rate_monitor_op.NO_DATA_PERIODS_FOR_STALL;
   M[$far_end.in.sw_rate_op.param + $cbops.rate_monitor_op.STALL_FIELD] = r1;
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.STALL_FIELD] = r1;
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.STALL_FIELD] = r1;



   M[$far_end.in.sw_rate_op.param + $cbops.rate_monitor_op.WARP_MSG_COUNTER_FIELD] = 0;
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.WARP_MSG_COUNTER_FIELD] = 0;
   M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.WARP_MSG_COUNTER_FIELD] = 0;
...
.CONST $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_ADC 3;
.CONST $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_DAC 4;

.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_USB 5;
.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_ADC 6;
.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_DAC 7;

.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_USB 8;
.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_ADC 9;
.CONST $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_DAC 10;

.CONST $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_USB 11;
.CONST $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_ADC 12;
.CONST $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_DAC 13;

.CONST $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_USB 14;
.CONST $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_ADC 15;
.CONST $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_DAC 16;

.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_USB 17;
.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_ADC 18;
.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_DAC 19;

.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_USB 20;
.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_ADC 21;
.CONST $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_DAC 22;

.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_USB 23;
.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_ADC 24;
.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_DAC 25;


.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_USB 26;
.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_ADC 27;
.CONST $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_DAC 28;

.CONST $CVC_2MIC_PERSIST_NUM_ELEMENTS 29;
...
.MODULE $M.2mic.LoadPersistResp;
   ...
   .VAR persistent_current_alpha_index_adc = 0;
   .VAR persistent_average_io_ratio_adc = 0.0;
   .VAR persistent_warp_value_adc = 0.0;
   .VAR persistent_inverse_warp_value_adc = 0.0;
   .VAR persistent_sra_current_rate_adc = 0.0;


   .VAR persistent_current_alpha_index_dac = 0;
   .VAR persistent_average_io_ratio_dac = 0.0;
   .VAR persistent_warp_value_dac = 0.0;
   .VAR persistent_inverse_warp_value_dac = 0.0;
   .VAR persistent_sra_current_rate_dac = 0.0;
...
func:
   ...
   r0 = M[r3 + $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_ADC];
   M[persistent_current_alpha_index_adc] = r0;

   r0 = M[r3 + $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_DAC];
   M[persistent_current_alpha_index_dac] = r0;
   ...
   r0 = M[r3 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_average_io_ratio_adc] = r0;

   r0 = M[r3 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_average_io_ratio_dac] = r0;
   ...
   r0 = M[r3 + $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_warp_value_adc] = r0;

   r0 = M[r3 + $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_warp_value_dac] = r0;
   ...
   r0 = M[r3 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_inverse_warp_value_adc] = r0;

   r0 = M[r3 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_inverse_warp_value_dac] = r0;
   ...
   r0 = M[r3 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_ADC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_ADC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_sra_current_rate_adc] = r0;

   r0 = M[r3 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_DAC];
   r1 = M[r3 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_DAC];
   r0 = r0 LSHIFT 8;
   r1 = r1 AND 0xff;
   r0 = r0 OR r1;
   M[persistent_sra_current_rate_dac] = r0;

   rts;
.ENDMODULE;
.linefile 2434 "cvc_headset_2mic_config.asm"
...
persist_store:
   ...
   r0 = M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.CURRENT_ALPHA_INDEX_FIELD];
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_ADC] = r0;

   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.CURRENT_ALPHA_INDEX_FIELD];
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_CURRENT_ALPHA_INDEX_OFFSET_DAC] = r0;
   ...
   r0 = M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_ADC] = r1;

   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_AVERAGE_IO_RATIO_LO_OFFSET_DAC] = r1;
   ...
   r0 = M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_ADC] = r1;

   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_WARP_VALUE_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_WARP_VALUE_LO_OFFSET_DAC] = r1;
   ...
   r0 = M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_ADC] = r1;

   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_INVERSE_WARP_VALUE_LO_OFFSET_DAC] = r1;
   ...
   r0 = M[$adc_in.sw_rate_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_ADC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_ADC] = r1;

   r0 = M[$dac_out.sw_rate_monitor_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD];
   r1 = r0 LSHIFT -8;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_HI_OFFSET_DAC] = r1;
   r1 = r0 AND 0xff;
   M[&persist_data_2mic + 1 + $CVC_2MIC_PERSIST_SRA_CURRENT_RATE_LO_OFFSET_DAC] = r1;
...
.ENDMODULE;
.linefile 2634 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2713 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2739 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 2943 "cvc_headset_2mic_config.asm"
...
.ENDMODULE;
.linefile 3055 "cvc_headset_2mic_config.asm"
...
$cvc.mc.agc_snd:
   ...
   r0 = r1 AND $M.CVC_HEADSET_2MIC.CONFIG.BYPASS_SNDAGC;
   if NZ rts;
.linefile 3115 "cvc_headset_2mic_config.asm"
...
$cvc.mc.aec500_cng:
.linefile 3271 "cvc_headset_2mic_config.asm"
   jump $cvc.mc.aec500;
...
$cvc.mc.mgdc100:
   ...
   if NZ rts;
.linefile 3296 "cvc_headset_2mic_config.asm"
   r0 = 0;
   r1 = M[$cvc.echo_flag];
...
.ENDMODULE;
.linefile 3421 "cvc_headset_2mic_config.asm"
