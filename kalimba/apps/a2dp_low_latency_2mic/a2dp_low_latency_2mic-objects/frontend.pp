...
.linefile 37 "frontend.asm" 2
.linefile 47 "frontend.asm"
...
.CONST $OUTPUT_AUDIO_CBUFFER_SIZE ((15*1500 * 48)/1000);
...
func:
   ...
   M[audio_if_mode] = r0;
.linefile 125 "frontend.asm"
   r0=1;
   M[$M.dac_out.dac_sr_flag] = r0;
   rts;

.ENDMODULE;
.linefile 139 "frontend.asm"
.MODULE $M.adc_in;
   .DATASEGMENT DM;

   .VAR/DMCIRC audio_in_left[720]; .VAR audio_in_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(audio_in_left), &audio_in_left, &audio_in_left;
   .VAR/DMCIRC audio_in_right[720]; .VAR audio_in_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(audio_in_right), &audio_in_right, &audio_in_right;
...
.MODULE $M.dac_out;
   ...
   .VAR $calc_actual_samples_struc[$calc_actual_samples.STRUC_SIZE] =
    ...
    .VAR/DMCIRC dac_out_left[$OUTPUT_AUDIO_CBUFFER_SIZE]; .VAR left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(dac_out_left), &dac_out_left, &dac_out_left;
    .VAR/DMCIRC dac_out_right[$OUTPUT_AUDIO_CBUFFER_SIZE]; .VAR right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(dac_out_right), &dac_out_right, &dac_out_right;
    .VAR/DMCIRC Reference.mem[720]; .VAR Reference.cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(Reference.mem), &Reference.mem, &Reference.mem;
