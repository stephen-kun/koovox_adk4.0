...
.ENDMODULE;
.linefile 279 "backend.asm"
.MODULE $M.a2dp_out;
   .DATASEGMENT DM;

   .VAR/DMCIRC codec_out[1024]; .VAR codec_out_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(codec_out), &codec_out, &codec_out;
   .VAR/DMCIRC encoder_in[1024]; .VAR encoder_in_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(encoder_in), &encoder_in, &encoder_in;
...
.MODULE $M.a2dp_in;
   ...
   .VAR/DMCIRC decoder_out_left[720]; .VAR decoder_out_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(decoder_out_left), &decoder_out_left, &decoder_out_left;
   .VAR/DMCIRC decoder_out_right[720]; .VAR decoder_out_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(decoder_out_right), &decoder_out_right, &decoder_out_right;
   .VAR/DMCIRC decoder_in[1024]; .VAR decoder_in_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH(decoder_in), &decoder_in, &decoder_in;
...
skip_aptx_acl_sprint:
   ...
   Null = r1 - $APTX_ACL_SPRINT_IO;
   if NZ jump skip_aptx_acl_sprint1;
.linefile 1039 "backend.asm"
skip_aptx_acl_sprint1:
.linefile 1049 "backend.asm"
