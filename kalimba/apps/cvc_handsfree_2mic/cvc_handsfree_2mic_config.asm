...
// Configure PLC and Codecs
   ...
   r1 = M[$M.2micHF.LoadPersistResp.persistent_current_alpha_index_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.CURRENT_ALPHA_INDEX_FIELD] = r1;
   
   r1 = M[$M.2micHF.LoadPersistResp.persistent_current_alpha_index_dac];
   ...
   r1 = M[$M.2micHF.LoadPersistResp.persistent_average_io_ratio_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.AVERAGE_IO_RATIO_FIELD] = r1;
   
   r1 = M[$M.2micHF.LoadPersistResp.persistent_average_io_ratio_dac];
   ...
   r1 = M[$M.2micHF.LoadPersistResp.persistent_warp_value_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.WARP_VALUE_FIELD] = r1;
   
   r1 = M[$M.2micHF.LoadPersistResp.persistent_warp_value_dac];
   ...
   r1 = M[$M.2micHF.LoadPersistResp.persistent_inverse_warp_value_adc];
   M[$adc_in.sw_rate_op.param + $cbops.rate_monitor_op.INVERSE_WARP_VALUE_FIELD] = r1;
   
   r1 = M[$M.2micHF.LoadPersistResp.persistent_inverse_warp_value_dac];
   ...
   r1 = M[$M.2micHF.LoadPersistResp.persistent_sra_current_rate_adc];
   M[$adc_in.sw_copy_left_op.param + $cbops.rate_adjustment_and_shift.SRA_CURRENT_RATE_FIELD] = r1;
   
   r1 = M[$M.2micHF.LoadPersistResp.persistent_sra_current_rate_dac];
...
.CONST $CVC_2MIC_PERSIST_NUM_ELEMENTS                                29; // Number of persistance elements
