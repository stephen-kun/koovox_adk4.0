...
// Message Struc Ptr  Message ID  Message Handler  Registration Function
   ...
   &$M.music_example_message.multi_volume_message_struc,       $music_example.VMMSG.VOLUME,              &$M.music_example_message.MainVolume.func,       $message.register_handler,
   &$M.music_example_message.aux_volume_message_struc,         $music_example.VMMSG.AUXVOLUME,           &$M.music_example_message.AuxVolume.func,       $message.register_handler,
   ...
   &$M.music_example_message.set_output_dev_type_message_struc,        $M.music_example.VMMSG.SET_OUTPUT_DEV_TYPE,     &$M.music_example_message.SetOutputDevType.func,        $message.register_handler,
   ...
   &$M.music_example_message.multi_channel_main_mute_message_struc,    $M.music_example.VMMSG.MULTI_CHANNEL_MAIN_MUTE, &$M.music_example_message.MultiChannelMainMute.func,    $message.register_handler,
   &$M.music_example_message.multi_channel_aux_mute_message_struc,     $M.music_example.VMMSG.MULTI_CHANNEL_AUX_MUTE,  &$M.music_example_message.MultiChannelAuxMute.func,     $message.register_handler,
