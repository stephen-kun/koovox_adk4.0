...
// Part of ADK 4.0
//
// $Change: 2116105 $  $DateTime: 2015/03/12 08:59:55 $
// *****************************************************************************
...
.MODULE $M.tws.synchronise_master;
   ...
   r2 = $NUM_SYNCED_VOLUMES; //copy only system, master and tone
...
supported_tws_version:       
         ...
         // Copy volume message to scheduled volume 
         r1 = &$tws.scheduled_volume_struc;
         r2 = $NUM_SYNCED_VOLUMES; //copy only system, master 
...
$tws.set_synchronized_data_handler:
   ...
   //Calculate the amount of data in the delay buffer in uS  
   ...
   // upper 24 bits is the amount of time it will take the data to play out of this delay buffer
   r1 = rMAC1;
   ...
   // start mute before the transition
   r6 = r6 LSHIFT -4;
   r3 = r1 - r6;
