...
#ifdef uses_WIRED_SUB_COMPANDER
...
// This table must be null terminated.
   ...
   .VAR reinitialize_table[] =
    ...
    $volume_and_limit.initialize,  &multichannel_volume_and_limit_obj,   &multichannel_volume_and_limit_obj,
    $volume_and_limit.initialize,  &aux_stereo_volume_and_limit_obj,     &aux_stereo_volume_and_limit_obj,
...
#if uses_STEREO_ENHANCEMENT
        $MeloD_Expansion.process,                   &MeloD_Expansion_struct,    0,
