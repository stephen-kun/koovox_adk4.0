...
.linefile 1 "codec_decoder_faststream.asm"
.linefile 13 "codec_decoder_faststream.asm"
...
.linefile 14 "codec_decoder_faststream.asm" 2
...
.linefile 15 "codec_decoder_faststream.asm" 2
...
.linefile 16 "codec_decoder_faststream.asm" 2
...
.linefile 17 "codec_decoder_faststream.asm" 2
...
.linefile 18 "codec_decoder_faststream.asm" 2
...
.linefile 19 "codec_decoder_faststream.asm" 2
...
.linefile 20 "codec_decoder_faststream.asm" 2
...
.linefile 21 "codec_decoder_faststream.asm" 2
...
.linefile 22 "codec_decoder_faststream.asm" 2
...
.linefile 24 "codec_decoder_faststream.asm" 2
...
.MODULE $M.main;
   ...
   .VAR/DMCIRC $codec_in[1024]; .VAR $codec_in_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($codec_in), &$codec_in, &$codec_in;
   .VAR/DMCIRC $audio_out_left[720]; .VAR $audio_out_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($audio_out_left), &$audio_out_left, &$audio_out_left;
   .VAR/DMCIRC $audio_out_right[720]; .VAR $audio_out_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($audio_out_right), &$audio_out_right, &$audio_out_right;
...
.linefile 158 "codec_decoder_faststream.asm"
   .VAR $codec_type = -1;
...
.linefile 260 "codec_decoder_faststream.asm"
...
wait_for_some_codec_data:
   ...
   frame_loop:
      ...
      call $sra_calcrate;
.linefile 404 "codec_decoder_faststream.asm"
skip_decode:
...
.endmodule;
.linefile 491 "codec_decoder_faststream.asm"
...
.linefile 535 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 579 "codec_decoder_faststream.asm"
...
.linefile 668 "codec_decoder_faststream.asm"
   r1 = &$codec_timer_struc;
   r2 = M[$tmr_period_con_copy];
   r3 = &$codec_copy_handler;
   call $timer.schedule_event_in_period;
...
.ENDMODULE;
.linefile 704 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 748 "codec_decoder_faststream.asm"
...
.linefile 777 "codec_decoder_faststream.asm"
   rts;

.ENDMODULE;
.linefile 798 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 899 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 941 "codec_decoder_faststream.asm"
...
.ENDMODULE;
.linefile 999 "codec_decoder_faststream.asm"
.MODULE $M.conn_init;
...
.MODULE $M.master_app_reset;
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 1200 "codec_decoder_faststream.asm"
