...
.linefile 1 "multichannel_output.asm"
.linefile 14 "multichannel_output.asm"
...
.linefile 17 "multichannel_output.asm" 2
...
.linefile 23 "multichannel_output.asm" 2
...
.linefile 24 "multichannel_output.asm" 2





.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/spdif.h" 1
.linefile 10 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/spdif.h"
...
.linefile 109 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/spdif.h"
...
.linefile 157 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/spdif.h"
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/spdif_frame_copy.h" 1
.linefile 10 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/spdif_frame_copy.h"
...
.linefile 35 "multichannel_output.asm" 2
...
.linefile 83 "multichannel_output.asm"
   ...
   .VAR $hw_warp_struct[$hw_warp.STRUC_SIZE] =
       ...
       128,
       0 ...;
.linefile 205 "multichannel_output.asm"
   ...
   .VAR $interface_map_struc[$INTERFACE_MAP_SIZE]=
      ...
      0,
      0;
.linefile 240 "multichannel_output.asm"
   ...
   .BLOCK $chain0_ch0_mute_op; .VAR chain0_ch0_mute_op.next = $chain0_ch0_dc_remove_op; .VAR chain0_ch0_mute_op.func = $cbops.soft_mute; .VAR chain0_ch0_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 0, 0; .ENDBLOCK;
   ...
   .BLOCK $chain0_ch1_mute_op; .VAR chain0_ch1_mute_op.next = $chain0_ch1_dc_remove_op; .VAR chain0_ch1_mute_op.func = $cbops.soft_mute; .VAR chain0_ch1_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 1, 1; .ENDBLOCK;
   ...
   .BLOCK $chain0_anc_switch_op; .VAR chain0_anc_switch_op.next = $chain0_ch0_resamp_switch_op; .VAR chain0_anc_switch_op.func = $cbops.switch_op; .VAR chain0_anc_switch_op.param[$cbops.switch_op.STRUC_SIZE] = chain0_anc_enable, $chain0_ch0_dither_switch_op, $ANC_MASK, 0; .ENDBLOCK;
   ...
   .VAR/DM chain0_ch0_resamp_op.iir_temp[(384 + 10)]; .BLOCK $chain0_ch0_resamp_op; .VAR chain0_ch0_resamp_op.next = $chain0_ch1_resamp_switch_op; .VAR chain0_ch0_resamp_op.func = $cbops_iir_resamplev2; .VAR chain0_ch0_resamp_op.param[$iir_resamplev2.OBJECT_SIZE] = 0, 0, 0, -8, 0, chain0_ch0_resamp_op.iir_temp, length(chain0_ch0_resamp_op.iir_temp), 0 ...; .ENDBLOCK;
   ...
   .VAR/DM chain0_ch1_resamp_op.iir_temp[(384 + 10)]; .BLOCK $chain0_ch1_resamp_op; .VAR chain0_ch1_resamp_op.next = $cbops.NO_MORE_OPERATORS; .VAR chain0_ch1_resamp_op.func = $cbops_iir_resamplev2; .VAR chain0_ch1_resamp_op.param[$iir_resamplev2.OBJECT_SIZE] = 1, 0, 0, -8, 0, chain0_ch1_resamp_op.iir_temp, length(chain0_ch1_resamp_op.iir_temp), 0 ...; .ENDBLOCK;
   ...
   .BLOCK $chain0_ch2_mute_op; .VAR chain0_ch2_mute_op.next = $chain0_ch2_dc_remove_op; .VAR chain0_ch2_mute_op.func = $cbops.soft_mute; .VAR chain0_ch2_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 2, 2; .ENDBLOCK;
   ...
   .BLOCK $chain0_ch3_mute_op; .VAR chain0_ch3_mute_op.next = $chain0_ch3_dc_remove_op; .VAR chain0_ch3_mute_op.func = $cbops.soft_mute; .VAR chain0_ch3_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 3, 3; .ENDBLOCK;
   ...
   .BLOCK $chain0_ch4_mute_op; .VAR chain0_ch4_mute_op.next = $chain0_ch4_dc_remove_op; .VAR chain0_ch4_mute_op.func = $cbops.soft_mute; .VAR chain0_ch4_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 4, 4; .ENDBLOCK;
   ...
   .BLOCK $chain0_ch5_mute_op; .VAR chain0_ch5_mute_op.next = $chain0_ch5_dc_remove_op; .VAR chain0_ch5_mute_op.func = $cbops.soft_mute; .VAR chain0_ch5_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 5, 5; .ENDBLOCK;
...
.linefile 317 "multichannel_output.asm"
   ...
   .BLOCK $chain1_ch0_mute_op; .VAR chain1_ch0_mute_op.next = $chain1_ch0_dc_remove_op; .VAR chain1_ch0_mute_op.func = $cbops.soft_mute; .VAR chain1_ch0_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 0, 0; .ENDBLOCK;
   ...
   .BLOCK $chain1_ch1_mute_op; .VAR chain1_ch1_mute_op.next = $chain1_ch1_dc_remove_op; .VAR chain1_ch1_mute_op.func = $cbops.soft_mute; .VAR chain1_ch1_mute_op.param[$cbops.soft_mute_op.STRUC_SIZE_MONO] = 0, 0, 1, 1, 1; .ENDBLOCK;
...
.MODULE $M.multi_chan_config_cbops_copy_strucs;
   ...
   if Z jump skip_chain0_config;
      ...
      r3 = M[$M.multi_chan_output.chain0_anc_enable];
      ...
      if Z jump anc_192k;
         ...
         r0 = $M.iir_resamplev2.Up_320_Down_147.filter;
         r1 = $M.iir_resamplev2.Up_2_Down_1.filter;
         null = r2 - 48000;
         if Z r0 = r1;
         ...
         jump anc_rate_configured;

      anc_192k:


         r0 = $M.iir_resamplev2.Up_640_Down_147_low_mips.filter;
         r1 = $M.iir_resamplev2.Up_4_Down_1.filter;
         null = r2 - 48000;
         if Z r0 = r1;
         M[$M.multi_chan_output.chain0_ch0_resamp_op.param + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r0;
         M[$M.multi_chan_output.chain0_ch1_resamp_op.param + $iir_resamplev2.FILTER_DEFINITION_PTR_FIELD] = r0;
...
.linefile 468 "multichannel_output.asm"
   skip_chain0_config:
...
.ENDMODULE;
.linefile 549 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 602 "multichannel_output.asm"
...
.linefile 639 "multichannel_output.asm"
   pop r4;
   r4 = r4 AND r5;
   ...
   call $multi_chan_build_cbops_copy_struc;
.linefile 665 "multichannel_output.asm"
   jump $pop_rLink_and_rts;

.ENDMODULE;
.linefile 695 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 751 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 801 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 855 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 918 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 947 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 976 "multichannel_output.asm"
.MODULE $M.multi_chan_soft_mute;
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 1068 "multichannel_output.asm"
.MODULE $M.multi_chan_tones_active;
   ...
   rts;
.ENDMODULE;
.linefile 1108 "multichannel_output.asm"
.MODULE $M.multi_chan_clone_tone_cbuffers;
   ...
   rts;
.ENDMODULE;
.linefile 1170 "multichannel_output.asm"
.MODULE $M.multi_chan_adjust_tone_cbuffers;
   ...
   rts;
.ENDMODULE;
.linefile 1293 "multichannel_output.asm"
.MODULE $M.multi_chan_set_port_for_latency_calc;
   ...
   rts;
.ENDMODULE;
.linefile 1348 "multichannel_output.asm"
.MODULE $M.multi_chan_select_chain_usage;
   ...
   rts;
.ENDMODULE;
.linefile 1400 "multichannel_output.asm"
.MODULE $M.multi_chan_build_channel_type_mask;
   ...
   rts;
.ENDMODULE;
.linefile 1441 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 1562 "multichannel_output.asm"
...
.linefile 1582 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 1638 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 1675 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 1728 "multichannel_output.asm"
...
.ENDMODULE;
.linefile 1770 "multichannel_output.asm"
