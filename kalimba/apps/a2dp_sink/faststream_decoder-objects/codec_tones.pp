...
.linefile 23 "codec_tones.asm" 2

.MODULE $codec_tones;
   .DATASEGMENT DM;
   .CODESEGMENT PM;

   .VAR/DMCIRC $tone_in_left[192]; .VAR $tone_in_left_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_left), &$tone_in_left, &$tone_in_left;
   .VAR/DMCIRC $tone_in_right[192]; .VAR $tone_in_right_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_right), &$tone_in_right, &$tone_in_right;
   .VAR/DMCIRC $tone_in_left_resample[(192 * 6)]; .VAR $tone_in_left_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_left_resample), &$tone_in_left_resample, &$tone_in_left_resample;
   .VAR/DMCIRC $tone_in_right_resample[(192 * 6)]; .VAR $tone_in_right_resample_cbuffer_struc[$cbuffer.STRUC_SIZE] = LENGTH($tone_in_right_resample), &$tone_in_right_resample, &$tone_in_right_resample;
