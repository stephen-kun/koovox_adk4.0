...
.linefile 1 "music_example_config.asm"
.linefile 17 "music_example_config.asm"
...
.linefile 19 "music_example_config.asm" 2
...
.linefile 27 "music_example_config.asm" 2
.linefile 36 "music_example_config.asm"
...
.linefile 37 "music_example_config.asm" 2
...
.linefile 38 "music_example_config.asm" 2
.linefile 70 "music_example_config.asm"
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/music_manager_defaults.dat" 1
...
0x0003, 0xE000, 0x03E0,
0x0000, 0x0000
.linefile 82 "music_example_config.asm" 2
   ;
...
.linefile 208 "music_example_config.asm"
   ...
   .VAR right_headroom_obj[$M.audio_proc.stream_gain.STRUC_SIZE] =
     ...
     &headroom_mant,
     &ZeroValue;
.linefile 263 "music_example_config.asm"
   ...
   .VAR/DM2 spkr_eq_right_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((10)))+2) )] =
    ...
    .VAR SpkrEqDefnTable[$user_eq.DEFINITION_TABLE_SIZE] =
        ...
        &SpkrEqCoefsA,
        &SpkrEqCoefsB;
.linefile 373 "music_example_config.asm"
   ...
   .VAR/DM2 boost_eq_right_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((1)))+2) )] =
    ...
    .VAR BoostEqDefnTable[$user_eq.DEFINITION_TABLE_SIZE] =
        ...
        &BoostEqCoefsA,
        &BoostEqCoefsB;
.linefile 427 "music_example_config.asm"
   ...
   .VAR/DM2 user_eq_left_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((5)))+2) )] =
    ...
    .VAR/DM2 user_eq_right_dm2[($audio_proc.peq.STRUC_SIZE + ((3*((5)))+2) )] =
      ...
      &UserEqCoefsA,
      0 ...;
.linefile 575 "music_example_config.asm"
        .VAR UserEqCoefsA[33] =
            0x000000,
            0x000001,
            0x400000,
...
.linefile 624 "music_example_config.asm"
...
.ENDBLOCK;
    ...
    .VAR WiredSubEqDefnTable[$user_eq.DEFINITION_TABLE_SIZE] =
        ...
        &SubEqCoefsA,
        &SubEqCoefsB;
.linefile 963 "music_example_config.asm"
...
.ENDBLOCK;
.linefile 1203 "music_example_config.asm"
   .VAR dithertype = 0;
   ...
   .VAR StatisticsPtrs[$M.MUSIC_MANAGER.STATUS.BLOCK_SIZE] =
      ...
      &$codec_type,
      0 ...;
.linefile 1280 "music_example_config.asm"
   .VAR stream_map_left_in[$framesync_ind.ENTRY_SIZE_FIELD] =
    ...
    .VAR stream_map_right_in[$framesync_ind.ENTRY_SIZE_FIELD] =
          ...
          $frame_sync.update_input_streams_ind,
          0 ...;
.linefile 1315 "music_example_config.asm"
    ...
    .VAR stream_map_sub_out[$framesync_ind.ENTRY_SIZE_FIELD] =
     ...
     .VAR rcv_process_streams[] =
        ...
        &stream_map_sub_out,
        0;
.linefile 1420 "music_example_config.asm"
...
.linefile 1472 "music_example_config.asm"
    0;
   ...
   .VAR filter_reset_table[] =
    ...
    0;
.linefile 1510 "music_example_config.asm"
    .VAR mode_table[] =
        &copy_proc_funcs,
        &copy_proc_funcs,
        &full_proc_funcs,
        ...
        0;
.linefile 1541 "music_example_config.asm"
    .VAR copy_proc_funcs[] =
...
.linefile 1639 "music_example_config.asm"
        $volume_and_limit.apply_volume, &multichannel_volume_and_limit_obj, 0,
...
.ENDMODULE;
.linefile 1752 "music_example_config.asm"
...
.ENDMODULE;
.linefile 1880 "music_example_config.asm"
...
func:
   ...
   if Z r4=NULL;
   M[$DAC_conn_main] = r4;
.linefile 2065 "music_example_config.asm"
   r2 = $MULTI_CHAN_PRIMARY_CHANNELS_LEFT_MASK;
   Null = r0 and r2;
   if Z jump no_pri_left;
...
.linefile 2201 "music_example_config.asm"
  jump done;
