...
.linefile 1 "music_example_system.asm"
.linefile 14 "music_example_system.asm"
...
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/music_manager_config.h" 1
...
.linefile 42 "music_example_system.asm"
...
.linefile 118 "music_example_system.asm"
   jump $pop_rLink_and_rts;

.ENDMODULE;
.linefile 140 "music_example_system.asm"
...
lp_param_copy:
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 201 "music_example_system.asm"
...
initialize:
.linefile 222 "music_example_system.asm"
    r0 = M[&$M.system_config.data.CurParams + $M.MUSIC_MANAGER.PARAMETERS.OFFSET_CONFIG];
    r5 = M[r8];
...
process:
.linefile 257 "music_example_system.asm"
    r0 = M[&$M.system_config.data.CurParams + $M.MUSIC_MANAGER.PARAMETERS.OFFSET_CONFIG];
...
.ENDMODULE;
.linefile 290 "music_example_system.asm"
...
process:
   ...
   rts;
.ENDMODULE;
.linefile 355 "music_example_system.asm"
...
$music_example.power_up_reset:
   ...
   jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 443 "music_example_system.asm"
...
.ENDMODULE;
.linefile 562 "music_example_system.asm"
.MODULE $M.MUSIC_EXAMPLE_VERSION_STAMP;
   ...
   .ENDBLOCK;
.ENDMODULE;
.linefile 595 "music_example_system.asm"
.MODULE $M.MUSIC_EXAMPLE_MODULES_STAMP;
   ...
   .BLOCK ModulesStamp;
      ...
      .VAR s2 = 0xfeeb;
      .VAR s3 = 0xfeeb;
      .VAR CompConfig = ( (0x040000 * 1) + (0x020000 * 1) + (0x010000 * 1) + (0x008000 * 1) + (0x002000 * 1) + (0x001000 * 1) + (0x000800 * 1) + (0x000200 * 1) + (0x000100 * 1) + (0x000040 * 1) + (0x000080 * 1) + (0x200000 * 0) + (0x100000 * 0) + (0x080000 * 0) );
      .VAR s4 = 0xfeeb;
      .VAR s5 = 0xfeeb;
      .VAR s6 = 0xfeeb;
   .ENDBLOCK;
...
.BLOCK Statistics;
   ...
   .VAR SamplingRate = 0;
.linefile 679 "music_example_system.asm"
.ENDBLOCK;
