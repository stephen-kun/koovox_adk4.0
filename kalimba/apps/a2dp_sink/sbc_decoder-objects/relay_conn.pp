...
.linefile 1 "relay_conn.asm"
.linefile 13 "relay_conn.asm"
.linefile 1 "C:/ADK4.0.0/kalimba/lib_sets/sdk/include/stream_relay_library.h" 1
...
.linefile 175 "relay_conn.asm"
.ENDMODULE;
.linefile 190 "relay_conn.asm"
.MODULE $M.relay.init;
   .CODESEGMENT PM;
   .DATASEGMENT DM;
   ...
   call $message.register_handler;
.linefile 249 "relay_conn.asm"
done:

   jump $pop_rLink_and_rts;

.ENDMODULE;
.linefile 278 "relay_conn.asm"
...
.MODULE $M.tws.master.enable;
   ...
   r1 = &$M.music_example_message.multi_volume_message_struc;
...
.MODULE $M.tws.disable;
   ...
   r1 = &$M.music_example_message.multi_volume_message_struc;
   r2 = $music_example.VMMSG.VOLUME;
   r3 = &$M.music_example_message.MainVolume.func;
   call $message.register_handler;
...
$tws.set_synchronized_data_handler:
   ...
   r0 = M[$M.system_config.data.delay_left + $audio_proc.delay.DELAY_FIELD];
   r1 = M[$inv_dac_fs];
