...
usb_fix:
   ...
   skip_port_data:
.linefile 410 "sr_adjustment.asm"
   r0 = M[$sra_struct + $sra.CODEC_CBUFFER_TO_TAG_FIELD];
   call $cbuffer.calc_amount_data;
...
.ENDMODULE;
.linefile 715 "sr_adjustment.asm"
...
.ENDMODULE;
.linefile 791 "sr_adjustment.asm"
.MODULE $M.apply_sra_resampling_adjustment;
   ...
   rts;
.linefile 825 "sr_adjustment.asm"
.ENDMODULE;
.linefile 856 "sr_adjustment.asm"
...
.ENDMODULE;
.linefile 1236 "sr_adjustment.asm"
...
jump $pop_rLink_and_rts;
.ENDMODULE;
.linefile 1412 "sr_adjustment.asm"
...
.ENDMODULE;
.linefile 1434 "sr_adjustment.asm"
