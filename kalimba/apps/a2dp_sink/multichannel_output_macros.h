...
#define TEMPLATE_IIR_RESAMPLEV2_OP(name, next_op, in_idx, out_idx, filter_def, in_shift, out_shift)     \
                                                                                                        \
...
#define TEMPLATE_DITHER_AND_SHIFT_OP(name, next_op, in_idx, out_idx, dither_type)                       \
                                                                                                        \
