...
.MODULE $M.music_example_message;
   ...
   .VAR multi_volume_message_struc[$message.STRUC_SIZE];
   .VAR aux_volume_message_struc[$message.STRUC_SIZE];
   ...
   .VAR set_output_dev_type_message_struc[$message.STRUC_SIZE];
   .VAR set_i2s_mode_message_struc[$message.STRUC_SIZE];
   .VAR set_anc_mode_message_struc[$message.STRUC_SIZE];
   .VAR multi_channel_main_mute_message_struc[$message.STRUC_SIZE];
   .VAR multi_channel_aux_mute_message_struc[$message.STRUC_SIZE];
...
func:
   ...
   // This is a workaround for a problem caused by long messages being out of order.
   // It ensures that the wired output types are set before they are used.
   .DATASEGMENT DM;
   .VAR $SetOutputDevType_message_received;

   r0 = 1;
   M[$SetOutputDevType_message_received] = r0;
...
func:
   ...
   M[$M.multi_chan_output.chain0_anc_enable] = r1;    // Select ANC output rate (0: none, 1: 96kHz, 2: 192kHz)
